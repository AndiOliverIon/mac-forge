# Generated by Powerlevel10k configuration wizard on 2026-02-09 at 11:29 EET.
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_TAG
      ...
      # Keep tag names visible; directory shortening absorbs prompt pressure first.
      res+="${meta}#${clean}${tag//\%/%%}"
    fi
  ...
  typeset -g POWERLEVEL9K_DISABLE_HOT_RELOAD=true
	...
	# Show station name via the built-in context segment.
	typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%m'
	typeset -g POWERLEVEL9K_CONTEXT_DEFAULT_FOREGROUND=0
	typeset -g POWERLEVEL9K_CONTEXT_DEFAULT_BACKGROUND=3


  # Station name (short hostname)
  function prompt_station() {
    local h="${(%):-%m}"      # short hostname
	[[ -n $h ]] || return

	# Explicit colors to avoid empty powerline block
	# fg=black (0), bg=yellow (3) – tweak if you want
	p10k segment -t "$h" -f 0 -b 3
  }

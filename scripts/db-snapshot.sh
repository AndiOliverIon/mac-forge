...
#######################################
# Ensure snapshots path exists (host + container) and is writable
#######################################
...
#######################################
# Step 2 — Create snapshot directly into snapshots mount
#######################################
SNAPSHOT_NAME="${DB_SELECTED}_${SNAPSHOT_SUFFIX}.bak"
SNAPSHOT_PATH_CONTAINER="${FORGE_SQL_DOCKER_SNAPSHOTS_PATH}/${SNAPSHOT_NAME}"
SNAPSHOT_PATH_HOST="${FORGE_SQL_SNAPSHOTS_PATH}/${SNAPSHOT_NAME}"

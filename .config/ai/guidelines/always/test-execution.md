...
- Artanis, Karax, and Argus must not run frontend or backend unit tests—targeted or full suites, coverage,
...
- In review requests and findings, state `not run — awaiting Oliver's explicit authorization` unless
  Oliver authorized and the agent completed that specific run.

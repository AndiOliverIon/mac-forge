...
alias mc2h="~/mac-forge/scripts/git-peer-fetch.sh masterchief work"
alias r2h="~/mac-forge/scripts/git-peer-fetch.sh masterchief raynor"
alias z2h="~/mac-forge/scripts/git-peer-fetch.sh masterchief zeratul"
...
alias rdbsndrop="~/mac-forge/scripts/db-remote-snapshot-drop.sh"
alias rdown="~/mac-forge/linux/scripts/db-remote-download.sh"
alias dbo="~/mac-forge/scripts/db-optimize.sh"
alias binclear="~/mac-forge/scripts/bin-clear.sh"
...
alias pcr=perf-cache-reset
alias perftest="~/mac-forge/scripts/perform-test.sh"
alias organizer="~/mac-forge/scripts/organizer.sh"
alias org=organizer
alias o=organizer
alias dotnet-clean="~/mac-forge/scripts/dotnet-clean.sh"
alias dnc=dotnet-clean
alias dotnetbuild="~/mac-forge/scripts/dotnet-build.sh"
alias dnb=dotnetbuild
...
alias locsql='cd "$HOME/sql"'
alias lcsql=locsql
alias locsnapshots='cd "$HOME/sql/snapshots"'
alias lcsnaphots=locsnapshots
alias lcsnap=locsnapshots
...
alias vps1-status="~/mac-forge/scripts/vps1-status"
...
alias mcbt=mcboot
alias wake='~/mac-forge/scripts/wake.sh'
